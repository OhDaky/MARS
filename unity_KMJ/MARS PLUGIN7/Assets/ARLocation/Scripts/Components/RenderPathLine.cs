...
namespace ARLocation
{
    ...
    public class RenderPathLine : MonoBehaviour
    {
        ...
        private void LocationUpdated(LocationReading currentLocation, LocationReading lastLocation)
        {
            if (isDirty)
            {
            ...
            var displacement = Location.VectorFromTo(lastLocation.ToLocation(), currentLocation.ToLocation());
