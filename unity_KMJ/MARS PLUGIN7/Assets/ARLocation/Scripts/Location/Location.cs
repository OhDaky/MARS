...
namespace ARLocation
{
    ...
    public class Location
    {
        ...
        public bool ignoreAltitude
        {
            get
            {
                return altitudeMode == AltitudeMode.Ignore;
            }
        }
        ...
        public static Vector3 GetGameObjectPositionForLocation(Vector3 userPosition, Location userLocation, Location objectLocation, bool heightIsRelative)
        {
            ...
            return userPosition + dpos.toVector3() + new Vector3(0, (heightIsRelative && !objectLocation.ignoreAltitude) ? ((float)objectLocation.altitude - userPosition.y) : 0, 0);
        }
        ...
        public static Vector3 GetGameObjectPositionForLocation(Transform user, Location userLocation, Location objectLocation, bool heightIsRelative)
        {
            ...
            return user.position + dpos.toVector3() + new Vector3(0, (heightIsRelative && !objectLocation.ignoreAltitude) ? ((float)objectLocation.altitude - user.position.y) : 0, 0);
        }
