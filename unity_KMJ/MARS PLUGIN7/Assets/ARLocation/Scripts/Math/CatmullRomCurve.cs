...
namespace ARLocation
{
    ...
    public class CatmullRomCurve : Curve
    {
        ...
        /// Flag dirty sample.
        /// </summary>
        private bool isSampleDirty = true;
        ...
        /// <returns></returns>
        public override Vector3 GetPoint(float u = 0)
        {
            u = Mathf.Clamp(u, 0, 1);
            float t = t1 * (1 - u) + t2 * u;
        ...
        /// <param name="u">The curve parameter in the [0, 1] interval.</param>
        /// <returns></returns>
        public override CurvePointData GetPointAndTangent(float u = 0)
        {
            u = Mathf.Clamp(u, 0, 1);
            float t = t1 * (1 - u) + t2 * u;
